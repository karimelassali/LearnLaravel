...
<section class="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="https://cdn.rareblocks.xyz/collection/celebration/images/logo.svg" alt="" />
                   <h1 class="text-3xl font-bold leading-tight text-red-300 sm:text-4xl lg:text-5xl mt-7" >{{$slot}}</h1>
                <p class="text-base leading-relaxed text-gray-600 mt-7">Amet {{$name}} {{$age}} minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
        ...
        <p class="text-sm text-center text-gray-600">© Copyright {{date('Y')}}, All Rights Reserved by Postcraft</p>
    </div>
</section>
